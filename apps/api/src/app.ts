...
export function createApp(): Express {
  ...
  // 批量抠图最多携带 5 张 10MB 图片；Base64 会膨胀约三分之一，先鉴权再为该路径放宽 JSON 体积。
  app.use("/api/external/image-cutout/remove-background/batch", requireExternalApiKey, express.json({ limit: "75mb" }))
