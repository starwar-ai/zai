...
const menuInputSchema = z.object({
  ...
  target: z.enum(["dashboard", "document-list", "settings", "help", "menu-management", "user-management", "role-management", "department-management", "declaration-name", "ocr-recognition", "image-search", "image-cutout"]),
