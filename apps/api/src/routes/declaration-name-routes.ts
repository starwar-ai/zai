...
import { getDeclarationNameJobController, getDeclarationNameReviews, postDeclarationNameApprove, postDeclarationNameGenerate, postDeclarationNameReject, postDeclarationNameResolve, postDeclarationNameWriteback, postExternalDeclarationNameBatchConvert, postExternalDeclarationNameConvert } from "../controllers/declaration-name-controller.js"
...
declarationNameRoutes.post("/external/declaration-names/convert/batch", requireExternalApiKey, asyncHandler(postExternalDeclarationNameBatchConvert))
