...
async function main(): Promise<void> {
  ...
  await prisma.role.upsert({ where: { code: "OCR_OPERATOR" }, update: { name: "OCR 识别员", description: "可使用支付截图和电子发票识别、查看个人记录并导出结果", permissions: ["dashboard:view", "ocr:view", "ocr:recognize", "ocr:delete", "ocr:export"] }, create: { code: "OCR_OPERATOR", name: "OCR 识别员", description: "可使用支付截图和电子发票识别、查看个人记录并导出结果", permissions: ["dashboard:view", "ocr:view", "ocr:recognize", "ocr:delete", "ocr:export"] } })
